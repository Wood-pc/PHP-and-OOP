<?php
$contact_phone_together = "+421900111222";
$contact_phone_space = "+421 900 111 222";
$contact_email = "mail@mailinator.com";
		...
		<div class="contact-bar">
			<div class="container">
				<ul class="menu personal">
					<li><i class="fa fa-phone"></i><a href="tel:'.$contact_phone_together.'">'.$contact_phone_space.'</a></li>
