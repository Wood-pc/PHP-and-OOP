			...
			<div class="post-content">
				<div class="container">
					...
					<ul class="menu controls">
						<li data-from="left"><a href="index.php?page=index">Všetko</a></li>
						<li data-from="right"><a href="web.php?page=web">Web</a></li>
						<li data-from="left"><a href="branding.php?page=branding">Branding</a></li>
						<li data-from="right"><a href="fotografia.php?page=fotografia">Fotografia</a></li>
